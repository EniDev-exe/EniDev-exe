# Olá, eu sou o Enivaldo Oliveira! 👋

### 👨‍💻 Sobre Mim
- 📍 **Salvador - Bahia** (Soteropolitano com orgulho!)
- 🎓 Cursando **Análise e Desenvolvimento de Sistemas** (3/5 Semestre)
- 🚀 Em busca da minha primeira oportunidade como **Estagiário de Desenvolvimento**
- 🎯 Focado em criar interfaces modernas, acessíveis e com código limpo.

---

### 🛠️ Minhas Habilidades
Tenho sólida experiência no ecossistema Front-end fundamental e estou expandindo meus horizontes para frameworks modernos.

- **Linguagens:** HTML5, CSS3, JavaScript (ES6+)
- **Lógica:** Resolução de problemas complexos e algoritmos.
- **Ferramentas:** Git, GitHub, VS Code.
- **Em breve:** ⚛️ Iniciando estudos em **React.js**.
